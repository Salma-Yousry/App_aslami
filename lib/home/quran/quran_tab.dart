...
class QuranTab extends StatelessWidget {
  ...
  /*List<int> verseCounts = [
    ...
    64, 77, 227, 93, 88, 69, 60, 34, 30, 73, 54, 45, 83, 182, 88, 75, 85, 54, 53, 89, 59, 37, 35, 38, 29,
    18, 45, 60, 49, 62, 55, 78, 96, 29, 22, 24, 13, 14, 11, 11, 18, 12, 12, 30, 52, 52, 44, 28, 28, 20,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children:[
        Expanded(child: Image.asset('assets/images/quran_tap.png')),
    Divider(
